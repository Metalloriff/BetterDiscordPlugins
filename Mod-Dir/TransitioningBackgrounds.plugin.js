//META{"name":"TransitioningBackgrounds","website":"https://github.com/Wrongyboi/BetterDiscordPlugins/blob/master/README.md","source":"https://github.com/Wrongyboi/BetterDiscordPlugins/blob/master/Mod-Dir/TransitioningBackgrounds.plugin.js"}*//
...
class TransitioningBackgrounds {
    ...
    start() {
		...
		if(lib == undefined) {
			...
			lib.setAttribute("src", "https://cdn.jsdelivr.net/gh/Wrongyboi/BetterDiscordPlugins@master/Mod-Dir/Lib/NeatoBurritoLibrary.js?forceNew=" + performance.now());
